  ...
  return (
    <div className="min-h-screen bg-white lg:flex">
      <aside className="border-b border-slate-200 bg-white lg:fixed lg:inset-y-0 lg:left-0 lg:w-56 lg:border-b-0 lg:border-r">
        ...
        <div className="m-4 hidden rounded-xl border border-slate-200 p-4 text-xs lg:block"><div className="flex items-center justify-between font-semibold text-slate-800"><span>Sync Status</span><span className="text-emerald-500">✓</span></div><p className="mt-3 text-slate-600">Connected to Google Drive</p><p className="mt-1 text-slate-400">Last sync: 2 min ago</p></div>
      </aside>
